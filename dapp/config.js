var txDefaultOrig =
{
  ...
  defaultChainID: null,
  // Mainnet
  walletFactoryAddress: "0x98f788606c518bf8def8cc1c331b8b21b7a78a5a",
  tokens: [
    {
...
var txDefault = {
  ethereumNodes : [
    ...
    {
      url : "http://172.16.1.8:8545",
      name: "Nexty local node"
    }
  ],
...
var oldWalletFactoryAddresses = [
  ("0x98f788606c518bf8def8cc1c331b8b21b7a78a5a").toLowerCase()
];
